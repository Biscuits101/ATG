...
*/
class SCR_ForceTimeAndWeatherComponent : SCR_BaseGameModeComponent
{
	//! Manager singleton instance, assigned on first get call
	private static SCR_ForceTimeAndWeatherComponent s_pInstance;
	...
	*/
	static SCR_ForceTimeAndWeatherComponent GetActiveComponent()
	{
		...
		if (!s_pInstance)
			s_pInstance = SCR_ForceTimeAndWeatherComponent.Cast(gameMode.FindComponent(SCR_ForceTimeAndWeatherComponent));
